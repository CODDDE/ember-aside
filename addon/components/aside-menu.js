...
import { createGesture } from "ember-aside/utils/gestures";
import layout from '../templates/components/aside-menu';
...
export default Component.extend(
  {
    ...
    _setScrollDisable() {
        ...
        const wasClosed = get(this, "wasClosed");       //TODO  preconfigure this with initial state
